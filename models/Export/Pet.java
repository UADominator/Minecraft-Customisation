...
public class Pet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pet = partdefinition.addOrReplaceChild("pet", CubeListBuilder.create().texOffs(0, 8).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 21.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
